...
(NULL, N'Cơm', 'Rice dishes', N'Các món cơm chính'),
(NULL, N'Bánh mì', 'Bread', N'Các loại bánh mì'),
(NULL, N'Đồ uống', 'Drinks', N'Nước uống các loại'),
(NULL, N'Bánh ngọt', 'Pastries', N'Bánh ngọt tráng miệng'),
(NULL, N'Đồ ăn nhẹ', 'Snacks', N'Các món ăn nhẹ ăn kèm'),
(NULL, N'Rau củ quả', 'Vegetables & Fruits', N'Rau củ quả tươi'),
(NULL, N'Thịt & Hải sản', 'Meat & Seafood', N'Thịt và hải sản tươi'),
(NULL, N'Sữa & Trứng', 'Dairy & Eggs', N'Sản phẩm từ sữa và trứng');
