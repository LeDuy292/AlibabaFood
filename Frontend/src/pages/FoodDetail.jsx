...
const FoodDetail = () => {
    ...
    const handleOrderNow = () => {
        ...
        console.log('Order now:', orderItem);
                            ...
                            <div className="options-row">
                                <div className="add-ons-col">
                                    ...
                                    <div className="add-on-list">
                                        {['Extra Grilled Pork Chop', 'Shredded Pork Skin', 'Steamed Egg Meatloaf', 'Fried Egg'].map((addon, idx) => (
                                ...
                                <div className="notes-col">
                                    ...
                                    <div className="action-buttons-group">
                                        <button className="add-to-cart-outline-btn" onClick={handleAddToCart}>Add to Cart</button>
                                        <button className="order-now-solid-btn" onClick={handleOrderNow}>ORDER NOW</button>
                                    </div>
                                </div>
                            </div>
                        </div>
