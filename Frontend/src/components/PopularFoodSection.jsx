...
const PopularFoodSection = () => {
  ...
  const handleAddToCart = (food) => {
    addToCart({
      id: `popular-${food.id}`,
      name: food.title,
      price: food.price * 10000,
      image: food.image,
      quantity: 1,
    });
    toast.success(`Đã thêm "${food.title}" vào giỏ hàng!`);
  };
  ...
  const popularFoods = [
    ...
    },
    {
      ...
      rating: "⭐⭐⭐⭐⭐",
      image:
        "https://images.unsplash.com/photo-1482049016688-2d3e1b311543?w=400&auto=format&fit=crop",
      featured: true,
    },
    {
      id: 3,
    ...
    },
    {
      ...
      rating: "⭐⭐⭐⭐",
      image:
        "https://images.unsplash.com/photo-1484723091791-c0e7e147c301?w=400&auto=format&fit=crop",
      featured: false,
    },
    {
      id: 5,
    ...
    <section className="popular-food-section container">
      ...
      <div className="popular-food-grid">
        {currentItems.map((food) => (
          <div
            key={food.id}
            className={`popular-card ${food.featured ? "featured" : ""}`}
          >
            ...
            <div className="popular-info">
              ...
              <div className="popular-price-row">
                <span className="popular-price">
                  {(food.price * 10000).toLocaleString("vi-VN")}đ
                </span>
                <button
      ...
      {totalPages > 1 && (
        <div className="food-pagination-wrapper">
          <button className="food-control-btn" onClick={handlePrev}>
            &larr;
          </button>
          ...
          <button className="food-control-btn" onClick={handleNext}>
            &rarr;
          </button>
        </div>
      )}
