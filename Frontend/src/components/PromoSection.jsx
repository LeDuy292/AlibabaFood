            ...
            <section className="promo-section">
                <div className="container promo-container">
                    <div className="promo-header">
                        <h2>Get a <span className="highlight-text">Voucher</span> and<br />enjoy your favorite meal!</h2>
                    </div>
                    ...
                    <div className="promo-grid">
                        ...
                        <div className="promo-card testy-burger">
                            ...
                            <img src="https://images.unsplash.com/photo-1568901346375-23c9450c58cd?auto=format&fit=crop&q=80&w=400" alt="Testy Burger" className="promo-img" />
                        </div>
                        ...
                        <div className="promo-cards-right-top">
                            ...
                            <div className="promo-card nodels-promo">
                                <div className="promo-content">
                                    ...
                                    <button className="add-to-cart-btn-small">Add To Cart</button>
                                </div>
                                <img src="https://images.unsplash.com/photo-1552611052-33e04de081de?auto=format&fit=crop&q=80&w=400" alt="Nodels" className="promo-img" />
                            </div>
                            ...
                            <div className="promo-card burger-promo">
                                ...
                                <img src="https://images.unsplash.com/photo-1550547660-d9450f859349?auto=format&fit=crop&q=80&w=400" alt="Burger" className="promo-img" />
                            </div>
                        </div>
                        ...
                        <div className="promo-card limited-offer">
                            ...
                            <button className="add-to-cart-btn-small">Add To Cart</button>
                            <img src="https://images.unsplash.com/photo-1513104890138-7c749659a591?auto=format&fit=crop&q=80&w=400" alt="Pizza" className="promo-img pizza-img" />
                        </div>
                    </div>
                ...
                <div className="container blind-bag-container">
                    ...
                    <div className="blind-bag-text">
                        ...
                        <h2 className="blind-bag-title">
                            Get a <span className="blind-bag-highlight">blind bag</span> and<br />
