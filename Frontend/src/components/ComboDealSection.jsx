        ...
        <section className="combo-deal-section">
            <div className="container">
                ...
                <div className="combo-nav">
                    <button className="combo-nav-btn" onClick={() => setStartIdx(i => Math.max(0, i - 1))} disabled={!canPrev} aria-label="Previous">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                            <path d="M15 18L9 12L15 6" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
                    </button>
                    <button className="combo-nav-btn" onClick={() => setStartIdx(i => Math.min(combos.length - CARDS_PER_VIEW, i + 1))} disabled={!canNext} aria-label="Next">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
